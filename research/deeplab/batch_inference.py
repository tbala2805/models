...
MODEL = DeepLabModel(os.path.join(os.getenv('VH_INPUTS_DIR'), 'model/frozen_inference_graph.pb'))
...
#Input image path
list_of_dirs.append(os.path.join(os.getenv('VH_INPUTS_DIR'), 'test-images'))
...
#output path
out_dir=os.path.join(os.getenv('VH_OUTPUTS_DIR'), 'results')
